...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2026 at 09:02 PM
...
(3, 'test1', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Lukas', 'Anic', 19, 73.00, 171.00, 'C:\\Users\\Administrator\\Desktop\\maturski - Copy\\maturski\\bin\\Debug\\ProfilnesSlike\\korisnik_3.png', 0),
(6, 'lukas', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'lukas', 'anic', 19, 73.00, 171.00, NULL, 0);
...
--
ALTER TABLE `planvjezba`
  MODIFY `PlanVjezbaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `trening`
--
ALTER TABLE `trening`
  MODIFY `TreningID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `vjezba`
  MODIFY `VjezbaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
