...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2026 at 10:43 PM
...
INSERT INTO `korisnik` (`KorisnikID`, `Username`, `PasswordHash`, `Ime`, `Prezime`, `Godine`, `Tezina`, `Visina`, `ZapamtiMe`) VALUES
(1, 'test', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Marko', 'Petrovic', 22, 80.00, 180.00, 0),
(3, 'test1', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Marko', 'Petrovic', 22, 80.00, 180.00, 0);
...
INSERT INTO `treningvjezba` (`ID`, `TreningID`, `VjezbaID`, `OdradjeniSetovi`, `MaxTezina`, `Uradjeno`) VALUES
(1, 1, 2, 0, 0.00, 0),
(2, 3, 1, 3, 2.00, 1),
(3, 3, 2, 3, 13.00, 1),
(4, 5, 2, 3, 7.00, 1),
...
--
ALTER TABLE `vjezba`
  MODIFY `VjezbaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
